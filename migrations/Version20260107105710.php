 ...
 */
final class Version20260107105710 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE review (id SERIAL NOT NULL, video_game_id INT NOT NULL, user_id INT NOT NULL, rating INT NOT NULL, comment TEXT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_794381C616230A8 ON review (video_game_id)');
        $this->addSql('CREATE INDEX IDX_794381C6A76ED395 ON review (user_id)');
        $this->addSql('CREATE TABLE "tag" (id SERIAL NOT NULL, code VARCHAR(255) NOT NULL, name VARCHAR(30) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_389B78377153098 ON "tag" (code)');
        $this->addSql('CREATE TABLE "user" (id SERIAL NOT NULL, username VARCHAR(30) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(60) NOT NULL, PRIMARY KEY(id))');
